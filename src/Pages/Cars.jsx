  ...
  return (
    <div>
      <div className='flex flex-col items-center py-20 bg-light max:md:px-4'>
        ...
        <div className='flex items-center bg-white px-4 mt-6 max-w-140 w-full h-12 roundec-full shadow'>
...
<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4 xl:px-20 ma-w-7xl mx-auto'>
